...
import { useDeleteMutation, useProfileMutation,useLogoutMutation } from "../../redux/api/users";
...
const Profile = () => {
  ...
  const deleteHandler=async(e)=>{
    try {
      ...
      if(res.success !== false){
        dispatch(logout())
         console.log("succesfully deleted your account");
  ...
  const logoutHandler=async(e)=>{
    try {
      ...
      if(res.success !== false){
        dispatch(logout())
         console.log("succesfully logged out your account");
